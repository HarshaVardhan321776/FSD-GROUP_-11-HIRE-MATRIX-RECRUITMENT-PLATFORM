...
const Landing = () => (
  <div className="landing hero-shell">
    ...
    <section className="hero glass" id="features">
      <div className="hero-grid">
        <div className="hero-copy">
          <span className="badge">Born in AI. Built for Hiring Teams.</span>
          <h1>The All-In-One Platform<br />For Candidate Conversations.</h1>
          <p>Streamline sourcing, screening, interviews, decisions, and communication in one synchronized recruiting workspace.</p>
          <div className="hero-actions">
            <Link to="/auth" className="btn">Launch HireMatrix</Link>
        ...
        <div className="hero-preview">
          <article className="ui-card">
            ...
            <p>12 candidates moved this week</p>
          </article>
          <article className="ui-card">
            <h4>Shortlist</h4>
            <p>3 new profiles ready for interviews</p>
          </article>
          <article className="ui-card">
            <h4>Interview Queue</h4>
            <p>6 scheduled conversations this week</p>
          </article>
          <article className="ui-card">
            <h4>Team Updates</h4>
            <p>Real-time notes across recruiting roles</p>
          </article>
        </div>
      </div>
    </section>
